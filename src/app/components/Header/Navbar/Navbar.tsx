  ...
  return (
    <nav className="mobile-navigation hidden shrink-0 md:flex items-center ml-auto">
      {linkNames.map((linkName) => (
        <NavLink
          styleClass="text-sm lg:text-base lg:tracking-wide font-semibold lg:px-3 px-[6px] py-[6px] rounded-sm hover:text-red-500 transition-color duration-150 md:ml-auto"
          key={t(`${linkName}.id`)}
